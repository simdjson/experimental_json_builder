...
We've seen different proposals for C++ reflection, for now we will focus on the [latest p2996 paper](https://isocpp.org/files/papers/P2996R7.html) that is targeting C++26.
